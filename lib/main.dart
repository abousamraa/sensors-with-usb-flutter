...
class _SensorMainState extends State<SensorMainHome> {
  ...
  void sendData(var sensorData) async {
    if (_port == null) {
      return;
    }
  ...
  void initState() {
    ...
    _getPorts();
    print("init ports ${_ports.length}");
    // end usb part
  }
          ...
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString =
                  'Accelerometer x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
            });
          }
        });
        break;
        ...
        _listGravity.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              item.z = sensorFeed[2];
              String sensorDataString =
                  'Gravity x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listLinearAcceleration.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              item.z = sensorFeed[2];
              String sensorDataString =
                  'LinearAcceleration x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listMagneticField.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              item.z = sensorFeed[2];
              String sensorDataString =
                  'MagneticField x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listOrientationSensor.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString =
                  'OrientationSensor azimuth: ${item.azimuth} , pitch: ${item.pitch} roll: ${item.roll}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listGyroscope.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString =
                  'Gyroscope angularSpeedAroundX: ${item.angularSpeedAroundX} , angularSpeedAroundY: ${item.angularSpeedAroundY} angularSpeedAroundZ: ${item.angularSpeedAroundZ}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listRotationVector.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              item.z = sensorFeed[2];
              String sensorDataString =
                  'RotationVector x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
        ...
        _listGameRotationVector.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              item.z = sensorFeed[2];
              String sensorDataString =
                  'GameRotationVector x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
              if (sensorFeed.length == 4)
                item.someVal = sensorFeed[3];
              else if (sensorFeed.length == 5)
        ...
        _listGeoMagneticRotationVector.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              item.z = sensorFeed[2];
              String sensorDataString =
                  'GeoMagneticRotationVector x: ${item.x} , y: ${item.y} z: ${item.z}';
              sendData(sensorDataString);
              if (sensorFeed.length == 4)
                item.someVal = sensorFeed[3];
              else if (sensorFeed.length == 5)
        ...
        _listRelativeHumidity.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString = 'humidity  ${item.humidity}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listAmbientRoomTemperature.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString =
                  'AmbientRoomTemperature ${item.temperature}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listStationaryDetect.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString = 'StationaryDetect ${item.isImmobile}';
              sendData(sensorDataString);
            });
          }
        });
        ...
        _listMotionDetect.forEach((item) {
          if (isAMatch(item.sensor, receivedData)) {
            ...
            setState(() {
              ...
              String sensorDataString = 'MotionDetect ${item.isInMotion}';
              sendData(sensorDataString);
            });
          }
        });
